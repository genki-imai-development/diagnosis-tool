...
export const DIAGNOSIS_PATTERNS: DiagnosisPattern[] = [
  {
    ...
    keywords: "冒険心,好奇心,自由",
    short_description: "新しいことへの好奇心が止まらず、自由な発想で未知の世界を探索する探検家。",
    keywords_summary: "あなたは生まれながらの冒険家です。新しいことへの好奇心が止まらず、誰にも縛られない自由な発想で世界を探索します。未知の体験に積極的に飛び込み、制約を嫌って自分らしい道を切り開いていく、真の探検家タイプです。",
    bestCompatibility: { id: "adventurer", name: "アドベンチャラー" },
    worstCompatibility: { id: "builder", name: "ビルダー" }
  },
  {
    id: "challenger",
    name: "チャレンジャー",
    ...
    keywords: "挑戦,情熱,突破力",
    short_description: "困難な目標にも恐れず立ち向かい、強い突破力で障害を乗り越える戦士。",
    keywords_summary: "あなたは燃える情熱を持った挑戦者です。困難な目標にも恐れることなく立ち向かい、強い突破力で障害を乗り越えます。熱い想いを原動力に、不可能を可能に変える力を持った、真の戦士タイプです。",
    bestCompatibility: { id: "maverick", name: "マーベリック" },
    worstCompatibility: { id: "guardian", name: "ガーディアン" }
  },
  {
    id: "builder",
    name: "ビルダー",
    ...
    short_description: "継続する力と職人気質で、着実に質の高い成果を生み出す匠。",
    keywords_summary: "あなたは確実性を重視する職人です。長期間にわたって継続する力と、細部までこだわる職人気質で、周囲から厚い信頼を得ています。一歩一歩着実に積み上げながら、質の高い成果を生み出す、真の匠タイプです。",
    bestCompatibility: { id: "realist", name: "リアリスト" },
    worstCompatibility: { id: "explorer", name: "エクスプローラー" }
  },
  {
    id: "dreamer",
    name: "ドリーマー",
    ...
    keywords: "想像力,感性,独創性",
    short_description: "無限の想像力と繊細な感性で、独創的なアイデアを生み出す芸術家。",
    keywords_summary: "あなたは豊かな内面世界を持つ夢想家です。無限の想像力と繊細な感性で、誰も思いつかない独創的なアイデアを生み出します。美しいものや感動的なものを察知する特別な感受性を持った、真の芸術家タイプです。",
    bestCompatibility: { id: "thinker", name: "シンカー" },
    worstCompatibility: { id: "driver", name: "ドライバー" }
  },
  {
    id: "connector",
    name: "コネクター",
    ...
    short_description: "優れた社交性でコミュニティを広げ、長続きする信頼関係を築く調整役。",
    keywords_summary: "あなたは人と人をつなぐ橋渡し役です。優れた社交性でコミュニティを広げ、協調性を大切にしながら長続きする信頼関係を築きます。チーム内の調和を促進し、みんなから頼られる、真の調整役タイプです。",
    bestCompatibility: { id: "supporter", name: "サポーター" },
    worstCompatibility: { id: "analyzer", name: "アナライザー" }
  },
  {
    id: "strategist",
    name: "ストラテジスト",
    ...
    short_description: "全体を俯瞰する戦略思考と冷静な判断力で、実現可能な計画を設計する参謀。",
    keywords_summary: "あなたは論理的思考の達人です。全体を俯瞰する戦略思考と冷静な判断力で、具体的で実現可能な計画を設計します。感情に左右されない客観性と、目標達成への緻密な計画性を持った、真の参謀タイプです。",
    bestCompatibility: { id: "tactician", name: "タクティシャン" },
    worstCompatibility: { id: "performer", name: "パフォーマー" }
  },
  {
    id: "innovator",
    name: "イノベーター",
    ...
    keywords: "革新,創造力,変革",
    short_description: "既存の枠組みを超えた創造力で新しい価値を生み出し、未来を創造する発明家。",
    keywords_summary: "あなたは常識を覆す革新者です。既存の枠組みを超えた創造力で全く新しい価値を生み出し、現状を変革する強い推進力を持っています。アイデアを現実に変える力で、より良い未来を創造する、真の発明家タイプです。",
    bestCompatibility: { id: "catalyst", name: "カタリスト" },
    worstCompatibility: { id: "observer", name: "オブザーバー" }
  },
  {
    id: "guardian",
    name: "ガーディアン",
    ...
    keywords: "責任感,統率力,保護",
    short_description: "深い責任感とリーダーシップで組織をまとめ、みんなを守り抜く統率者。",
    keywords_summary: "あなたは強い使命感を持つ守護者です。深い責任感とリーダーシップで組織をまとめ、大切な人や価値のあるものを保護します。チームの方向性を示しながら、みんなを守り抜く意志を持った、真の統率者タイプです。",
    bestCompatibility: { id: "leader", name: "リーダー" },
    worstCompatibility: { id: "challenger", name: "チャレンジャー" }
  },
  {
    id: "visionary",
    name: "ビジョナリー",
    ...
    short_description: "まだ誰も気づいていない変化を予見し、より良い明日を思い描く預言者。",
    keywords_summary: "あなたは未来を見通す預言者です。まだ誰も気づいていない変化を予見する先見性と、物事の本質を見抜く深い洞察力で、現在より良い明日を思い描きます。時代を先取りする感覚を持った、真の未来志向タイプです。",
    bestCompatibility: { id: "philosopher", name: "フィロソファー" },
    worstCompatibility: { id: "optimizer", name: "オプティマイザー" }
  },
  {
    id: "performer",
    name: "パフォーマー",
    ...
    short_description: "豊かな表現力で周囲を楽しませ、人を魅了し感動させるエンターテイナー。",
    keywords_summary: "あなたは天性のエンターテイナーです。豊かな表現力で周囲を楽しませ、情熱的な姿勢で場の雰囲気を明るくします。人を魅了し、感動させる特別な才能を持った、真のパフォーマータイプです。",
    bestCompatibility: { id: "optimist", name: "オプティミスト" },
    worstCompatibility: { id: "strategist", name: "ストラテジスト" }
  },
  {
    id: "analyzer",
    name: "アナライザー",
    ...
    short_description: "複雑な情報を整理する分析力で、パターンや法則を見つけ出す探究者。",
    keywords_summary: "あなたは真実を追求する研究者です。複雑な情報を整理する分析力と、深く掘り下げる研究心で、事実と根拠に基づく論理思考を展開します。パターンや法則を見つけ出し、真実に到達する、真の探究者タイプです。",
    bestCompatibility: { id: "observer", name: "オブザーバー" },
    worstCompatibility: { id: "connector", name: "コネクター" }
  },
  {
    id: "adventurer",
    name: "アドベンチャラー",
    ...
    keywords: "行動力,自由,探求心",
    short_description: "考えるより先に動く行動力で、新しい発見を求めて進み続ける旅人。",
    keywords_summary: "あなたは実践派の旅人です。考えるより先に動く行動力と、縛られない自由な精神で、未知の領域を探求します。経験から学び、新しい発見を求めて進み続ける、真の冒険者タイプです。",
    bestCompatibility: { id: "explorer", name: "エクスプローラー" },
    worstCompatibility: { id: "protector", name: "プロテクター" }
  },
  {
    id: "harmonizer",
    name: "ハーモナイザー",
    ...
    keywords: "調和,平和,癒し",
    short_description: "心地よい調和を作り、争いのない平和を維持する癒し手。",
    keywords_summary: "あなたは自然な癒し手です。みんなが心地よく過ごせる調和の取れた環境を作り、争いのない平和な状態を維持します。疲れた心を癒し、安らぎを与える、真の平和主義者タイプです。",
    bestCompatibility: { id: "nurturer", name: "ナーチュラー" },
    worstCompatibility: { id: "maverick", name: "マーベリック" }
  },
  {
    id: "seeker",
    name: "シーカー",
    ...
    keywords: "探求,成長,向上心",
    short_description: "諦めず探し続け、常により良い状態を目指す成長志向の探求者。",
    keywords_summary: "あなたは成長への飽くなき探求者です。答えや解決策を求めて諦めずに探し続け、常により良い状態を目指す向上心で、昨日より今日へと発展していきます。現状に満足しない、真の成長志向タイプです。",
    bestCompatibility: { id: "optimizer", name: "オプティマイザー" },
    worstCompatibility: { id: "catalyst", name: "カタリスト" }
  },
  {
    id: "rebel",
    name: "レベル",
    ...
    short_description: "既存のルールに挑戦し、自分だけの道を切り開く独立者。",
    keywords_summary: "あなたは自分らしさを貫く独立者です。他人に依存しない独立心と、既存のルールに挑戦する反骨精神で、誰とも違う特別な個性を発揮します。自分だけの道を切り開く、真の個性派タイプです。",
    bestCompatibility: { id: "pioneer", name: "パイオニア" },
    worstCompatibility: { id: "leader", name: "リーダー" }
  },
  {
    id: "leader",
    name: "リーダー",
    ...
    keywords: "指導力,包容力,統率",
    short_description: "組織を導く指導力と多様性を受け入れる包容力を持つ統率者。",
    keywords_summary: "あなたは天性のリーダーです。チームを正しい方向に導く指導力と、多様な人を受け入れる包容力で、組織全体を一つの方向に統率します。それぞれの良さを活かしながら目標達成を支援する、真の統率者タイプです。",
    bestCompatibility: { id: "guardian", name: "ガーディアン" },
    worstCompatibility: { id: "rebel", name: "レベル" }
  },
  {
    id: "thinker",
    name: "シンカー",
  ...
  },
  {
    ...
    short_description: "無駄を省き、最小の労力で最大の成果を出す効率の追求者。",
    keywords_summary: "あなたは効率を追求する実務家です。無駄を省く効率性と、理論より実際に役立つ実用性で、現状をより良い状態に最適化し続けます。最小の労力で最大の成果を出す、真の改善者タイプです。",
    bestCompatibility: { id: "seeker", name: "シーカー" },
    worstCompatibility: { id: "visionary", name: "ビジョナリー" }
  },
  {
    id: "creator",
    name: "クリエイター",
    ...
    keywords: "創作,芸術性,独創",
    short_description: "独創的なアイデアで美しさと感動を生み出す芸術家。",
    ...
    bestCompatibility: { id: "healer", name: "ヒーラー" },
    worstCompatibility: { id: "nurturer", name: "ナーチュラー" }
  },
  {
    id: "driver",
    name: "ドライバー",
    ...
    short_description: "困難に負けず、目標を確実に実現させる最後まで諦めない実行者。",
    keywords_summary: "あなたは目標達成の専門家です。迷わず進み続ける推進力と、困難に負けない粘り強さで、設定した目標を確実に実現させる達成力を発揮します。最後まで諦めない、真の実行者タイプです。",
    bestCompatibility: { id: "challenger", name: "チャレンジャー" },
    worstCompatibility: { id: "thinker", name: "シンカー" }
  },
  {
    id: "healer",
    name: "ヒーラー",
  ...
  },
  {
    ...
    short_description: "誰も歩いたことのない道を切り開き、未来を創造する開拓者。",
    ...
    bestCompatibility: { id: "rebel", name: "レベル" },
    worstCompatibility: { id: "supporter", name: "サポーター" }
  },
  {
    id: "protector",
    name: "プロテクター",
  ...
  },
  {
    ...
    keywords: "観察力,忍耐,冷静",
    short_description: "細かい変化を見逃さず、冷静な判断で状況を正確に把握する観察者。",
    keywords_summary: "あなたは洞察に優れた観察者です。細かい変化も見逃さない観察力と、時間をかけて物事に取り組む忍耐力で、感情に流されない冷静な判断を下します。状況を正確に把握する、真の賢者タイプです。",
    bestCompatibility: { id: "analyzer", name: "アナライザー" },
    worstCompatibility: { id: "innovator", name: "イノベーター" }
  },
  {
    id: "maverick",
    name: "マーベリック",
  ...
  },
  {
    ...
    keywords: "支援,協力,温厚",
    short_description: "温厚な人柄で他人の成功を後押しし、チームワークを大切にする支援者。",
    keywords_summary: "あなたは頼れるサポーターです。他人の成功を後押しする支援の心と、チームワークを大切にする協力精神で、穏やかで温厚な人柄を示します。みんなと一緒に目標達成を目指す、真のサポータータイプです。",
    bestCompatibility: { id: "connector", name: "コネクター" },
    worstCompatibility: { id: "pioneer", name: "パイオニア" }
  },
  {
    id: "tactician",
    name: "タクティシャン",
    ...
    keywords: "戦術,戦略,知略",
    short_description: "最適な戦術と長期的な戦略で、困難な問題を解決する知略家。",
    keywords_summary: "あなたは知略に優れた戦略家です。具体的な状況に応じて最適な戦術を選択し、長期的な視点で戦略を立案します。頭脳を使って困難な問題を解決する知恵と工夫で、勝利を導く、真のタクティシャンタイプです。",
    bestCompatibility: { id: "strategist", name: "ストラテジスト" },
    worstCompatibility: { id: "optimist", name: "オプティミスト" }
  },
  {
    id: "nurturer",
    name: "ナーチュラー",
    ...
    keywords: "育成,成長,仲間思い",
    short_description: "才能を見つけて育成し、仲間の幸せと成長を支える教育者。",
    keywords_summary: "あなたは他人を育てる教育者です。他人の才能を見つけて育成する愛情と、時間をかけて着実に成長していく発達への理解で、仲間の幸せを大切に思う心を持ちます。みんなの成長を支える、真のナーチュラータイプです。",
    bestCompatibility: { id: "harmonizer", name: "ハーモナイザー" },
    worstCompatibility: { id: "creator", name: "クリエイター" }
  },
  {
    id: "catalyst",
    name: "カタリスト",
    ...
    keywords: "触媒,変革,刺激",
    short_description: "良い影響を与え、新鮮な刺激で周囲を活性化させる触媒。",
    keywords_summary: "あなたは変化を促す触媒です。周囲の人や環境に良い影響を与える触媒の力と、現状をより良い方向に導く変革の推進力で、マンネリを破る新鮮な刺激を与えます。周囲を活性化させる、真のカタリストタイプです。",
    bestCompatibility: { id: "innovator", name: "イノベーター" },
    worstCompatibility: { id: "seeker", name: "シーカー" }
  },
  {
    id: "realist",
    name: "リアリスト",
    ...
    keywords: "現実主義,堅実,実直",
    short_description: "現実を重視した堅実な判断で、確実で安全な道を選ぶ現実家。",
    keywords_summary: "あなたは地に足のついた現実家です。理想より現実を重視する現実主義と、リスクを避ける堅実な判断で、飾らず偽らない実直な人柄を示します。確実で安全な方法を選択する、真のリアリストタイプです。",
    bestCompatibility: { id: "builder", name: "ビルダー" },
    worstCompatibility: { id: "dreamer", name: "ドリーマー" }
  },
  {
    id: "optimist",
    name: "オプティミスト",
    ...
    short_description: "困難でも希望を見出し、周囲を元気にする明るい楽天家。",
    keywords_summary: "あなたは太陽のような楽天家です。困難な状況でも希望を見出す楽観的な心と、物事の良い面に注目するポジティブな姿勢で、周囲を元気にする明るさを放ちます。場の雰囲気を明るくする、真のオプティミストタイプです。",
    bestCompatibility: { id: "performer", name: "パフォーマー" },
    worstCompatibility: { id: "tactician", name: "タクティシャン" }
  },
  {
    id: "philosopher",
    name: "フィロソファー",
